    ...
    <div className='bstc'> 
            ...
            <Container>
                <Row className='bstc-winner'>
                    <Col>
                        <img alt='Kanishk' className='winner-img' src={ require("../Images/BSTC/Achint.png").default } />
                        <h3 className='bstc-name'>Kanishk Yadav</h3>
                        <h5>Marks : 40</h5>
                    </Col>
                    <Col>
                        <img alt='Chetan' className='winner-img' src={require('../Images/BSTC/Aman.png').default} />
                        <h3 className='bstc-name'>Chetan Gupta</h3>
                        <h5>Marks : 39</h5>
                    </Col>
                    <Col>
                        <img alt='Mukesh' className='winner-img' src={require('../Images/BSTC/Giridhar.png').default} />
                        <h3 className='bstc-name'>Mukesh Bani</h3>
                        <h5>Marks : 38</h5>
                    </Col>
                    <Col>
                        <img alt='Aditya' className='winner-img' src={require('../Images/BSTC/Harshit.png').default} />
                ...
                <Row className='bstc-winner'>
                    ...
                    <Col>
                        <img alt='Sumit' className='winner-img' src={require('../Images/BSTC/Himanshu.png').default} />
                        <h3 className='bstc-name'>Sumit Verma</h3>
                        <h5>Marks : 38</h5>
                    </Col>
                    <Col>
                        <img alt='Arshad' className='winner-img' src={require('../Images/BSTC/Krishna.png').default} />
                ...
                <Row className='bstc-winner'>
                    ...
                    <Col>
                        <img alt='Tarun' className='winner-img' src={require('../Images/BSTC/Mukul.png').default} />
                        <h3 className='bstc-name'>Tarun Thusu</h3>
                        <h5>Marks : 36</h5>
                    </Col>
                    <Col>
                        <img alt='Sahil' className='winner-img' src={require('../Images/BSTC/Nirdosh.png').default} />
                ...
                <Row className='bstc-winner'>
                    <Col>
                        <img alt='Nitesh' className='winner-img' src={require('../Images/BSTC/Pushpankar.png').default} />
